...
def build_system_prompt() -> str:
    cost = ACTION_STAMINA_COST[GameAction.EXPLORE]
    return f"""
    ...
    Available tools:
    - explore(): Explore the surroundings and encounter a random event. You may find food or a drink that is added to your backpack, or nothing useful.
    ...
    Rules:
    - Each successful explore() costs {cost} stamina. You need at least {cost} stamina to explore.
    - Calling end_day() restores 10 stamina, up to the maximum stamina.
